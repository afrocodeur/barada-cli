        ...
        <table>
            ...
            @foreach($items as $item)
                <tr>
                    ...
                    <td>
                        <a class = '' href="{{ route('barada.command.show', $item->id) }}">Show</a>
                        <a class = '' href="{{ route('barada.command.edit', $item->id) }}">Edit</a>
                        <form action="{{ route('barada.command.destroy', $item->id) }}" method="POST" >
                            @method('DELETE')
                            @csrf
